...
class Production extends CI_Model {
    ...
    function get_production_total($location_code, $location_type, $year, $ecosystem){
        
        $this->db->select('l.locName AS location_name, k.year AS year, SUM("k"."estProduction") as value');
    ...
    function get_production_totals($location_code = null, $location_type,  $year_start, $year_end = NULL, $ecosystem, 
    ...
    function get_production_totals_regions($location_code = null, $location_type,  $year_start, $year_end = NULL, $ecosystem, 
                                   $order = NULL, $limit = NULL, $region_code = NULL){
    ...
    function get_production_totals_geocodes($location_code = null, $location_type,  $year_start, $year_end = NULL, 
    ...
    function get_production_totals_geocodes_regions($location_code = null, $location_type, $year_start, $year_end = NULL, 
                                           $ecosystem, $order = NULL, $limit = NULL, $region_code = NULL){
        ...
        if(!isset($location_code)){
            ...
            if ($location_type == 1) {
                ...
                $this->db->select('l.locName AS location_name, g.geoCode AS map_ID, k.year AS year, k.estProduction as value');
