...
class Harvestarea extends CI_Model {
    ...
    function get_harvestarea_totals($location_code = null, $location_type,  $year_start, $year_end = NULL, $ecosystem, 
    ...
    function get_harvestarea_totals_regions($location_code = null, $location_type,  $year_start, $year_end = NULL, $ecosystem, 
                                   $order = NULL, $limit = NULL, $region_code = NULL){
    ...
    function get_harvestarea_totals_geocodes_regions($location_code = null, $location_type, $year_start, $year_end = NULL, 
                                           $ecosystem, $order = NULL, $limit = NULL, $region_code = NULL){
        ...
        if(!isset($location_code)){
            ...
            if ($location_type == 1) {
                ...
                $this->db->select('l.locName AS location_name, g.geoCode AS map_ID, k.year AS year, k.areaHarv as value');
