...
<html>
    ...
    <head>
        ...
        <title>Farming Experience</title>
        ...
        <div class="sublevel container">
                ...
                <div class="col">
                    <div class="card-deck mb-2 text-center">
                        ...
                        <div class="card primary mb-4 bg-primary-2 text-white">
                          <div class="card-body">
                            <h5 class="card-title pb-2">Farming Experience (2017)</h5>
                ...
                <div class="col">
                    <div class="card mb-4">
                          <div class="card-header text-left">
                            <h5 class="my-0 pt-2 pb-2">Mean farming experience of rice farmers (1997-2017)</h5>
            ...
            <div class="row">
                <div class="col">
                    <div class="card mb-4">
                        <div class="card-header text-left">
                            <h5 class="my-0 pt-2 pb-2">Mean farming experience of rice farmers, by province (2017)</h5>
                            <p class="my-0 font-weight-normal text-muted">in years (RBFHS, PhilRice-SED, 2019)</p>
                        </div>
                        <div class="card-body">
                            <table class="table table-hover">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col">Average (Irrigated)</th>
                                  <th scope="col">Average (Rainfed)</th>
                                </tr>
                              </thead>
                              <tbody>
                                  <?php
