                          ...
                          <div class="card-body">
                                ...
                                <div class="row mt-2">
                                    <div class="col border-right">
                                        ...
                                        <h1 class="card-text font-weight-bold smaller"><?php echo $hy_all_ws['value']; ?>%<i class="bi bi-caret-up-fill"></i></h1>
                                    </div>
                                    <div class="col border-right">
                                        <p class="card-title-note">High Quality Inbred</p>
                                        <h1 class="card-text font-weight-bold smaller"><?php echo $hq_all_ws['value']; ?>%<i class="bi bi-caret-up-fill"></i></h1>
                                    </div>
                                    <div class="col">
                                        <p class="card-title-note">Farmer's Seeds</p>
                                        <h1 class="card-text font-weight-bold smaller"><?php echo $gs_all_ws['value'] + $fs_all_ws['value']; ?>%<i class="bi bi-caret-down-fill"></i></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card primary mb-2 bg-warning-2 text-white">
                          <div class="card-body">
                                ...
                                <div class="row mt-2">
                                    <div class="col border-right">
                                        <p class="card-title-note">Hybrid</p>
                                        <h1 class="card-text font-weight-bold smaller"><?php echo $hy_all['value']; ?>%<i class="bi bi-caret-up-fill"></i></h1>
                                    </div>
                                    <div class="col border-right">
                                        <p class="card-title-note">High Quality Inbred</p>
                                        <h1 class="card-text font-weight-bold smaller"><?php echo $hq_all['value']; ?>%<i class="bi bi-caret-down-fill"></i></h1>
                                    </div>
                                    <div class="col">
                                        <p class="card-title-note">Farmer's Seeds</p>
                                        <h1 class="card-text font-weight-bold smaller"><?php echo $gs_all['value'] + $fs_all['value']; ?>%<i class="bi bi-caret-down-fill"></i></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
