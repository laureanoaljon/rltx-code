                            ...
                            <table class="table table-hover">
                              ...
                              <tbody>
                                  <?php
                                        ...
                                        for ($i = 0; $i < count($fert_provincial); $i++) {
                                            
                                            if($fert_provincial[$i]['region'] != $temp_region){
                                                echo "<tr>";
                                                echo '<td colspan="5"><span class="font-weight-bold">'. $fert_provincial[$i]['region'] . '</td>';
                                                echo "</tr>";
                                            }
                                            
                                            $temp_region = $fert_provincial[$i]['region'];
                                            
                                            if($fert_provincial[$i]['location_name'] != $temp_prov){
                                                echo "<tr>";
                                                echo "<td>" . $fert_provincial[$i]['location_name'] . "</td>"; 
                                                echo '<td>'. ucwords($fert_provincial[$i]['label'])   .'</td>'; $i++;
                                                echo '<td>'. ucwords($fert_provincial[$i]['label']) .'</td>'; $i++;
                                                echo '<td>'. ucwords($fert_provincial[$i]['label']) .'</td>';
                                                echo "</tr>";
                                            }
                                            
                                            $temp_prov = $fert_provincial[$i]['location_name'];
