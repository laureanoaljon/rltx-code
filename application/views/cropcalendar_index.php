        ...
        <div class="sublevel">
                ...
                <div class="col">
                    <div class="card mb-4">
                        <div class="card-header text-left">
                            <h5 class="my-0 pt-2 pb-2">Cropping Schedule, All Months, Percentage (First, Second and Third Crop), All Ecosystems (2016)</h5>
            ...
            <div class="row">
                <div class="col">
                    <div class="card mb-4">
                        <div class="card-header text-left">
                            <h5 class="my-0 pt-2 pb-2">Top planting and harvesting month (first, second and third crop) by province (2016)</h5>
                            <p class="my-0 font-weight-normal text-muted">in percent (RBFHS, PhilRice-SED, 2019)</p>
                        </div>
                        <div class="card-body">
                            <table class="table table-hover">
                              ...
                              <tbody>
                                  <?php
                                        ...
                                        for ($i = 0; $i < count($plt1_provincial); $i++) {
                                            
                                            if($plt1_provincial[$i]['region'] != $temp_region){
                                                echo "<tr>";
                                                echo '<td colspan="7"><span class="font-weight-bold">'. $plt1_provincial[$i]['region'] . '</td>';
                                                echo "</tr>";
                                            }
                                            
                                            $temp_region = $plt1_provincial[$i]['region'];
                                            
                                            if($plt1_provincial[$i]['location_name'] != $temp_prov){
                                                echo "<tr>";
                                                echo "<td>" . $plt1_provincial[$i]['location_name'] . "</td>";
                                                echo "<td>" . $plt1_provincial[$i]['month'] . "</td>";
                                                echo "<td>" . $hlt1_provincial[$i]['month'] . "</td>";
                                                echo "<td>" . $plt2_provincial[$i]['month'] . "</td>";
                                                echo "<td>" . $hlt2_provincial[$i]['month'] . "</td>";
                                                echo "<td>" . $plt3_provincial[$i]['month'] . "</td>";
                                                echo "<td>" . $hlt3_provincial[$i]['month'] . "</td>";
                                                echo "</tr>";
                                            }
                                            
                                            $temp_prov = $plt1_provincial[$i]['location_name'];
