        ...
        <!-- Header --->
         <div id="seedrate" class="jumbotron text-center">
            <div class="jumbotron-content">
                <h2>Rice Farming Practices in <?php echo $trans_all['location_name']?></h2>
                <h1>Seeding Rate</h1>
            </div>
        </div>
                    ...
                    <div class="card-deck mb-2 text-center text-white">
                        <div class="card primary mb-4 bg-primary-3">
                          <div class="card-body">
                            ...
                            <h1 class="card-text font-weight-bold"><?php echo (!intval($trans_all['value']) == 0) ? number_format($trans_all['value']) : "-"; ?><i class="<?php echo $transr_caret; ?>"></i></h1>
                        ...
                        <div class="card primary mb-4 bg-warning-2 text-white">
                          <div class="card-body">
                            ...
                            <h1 class="card-text font-weight-bold"><?php echo (!intval($average_all['value']) == 0) ? number_format($average_all['value']) : "-"; ?><i class="<?php echo $aver_caret; ?>"></i></h1>
                        ...
                        <div class="card primary mb-4 bg-primary-3">
                          <div class="card-body">
                            ...
                            <h1 class="card-text font-weight-bold"><?php echo (!intval($direct_all['value']) == 0) ? number_format($direct_all['value']) : "-"; ?><i class="<?php echo $directr_caret; ?>"></i></h1>
                            <div class="card-note w-75 mx-auto rounded-pill bg-alternate"><p class="text-white">kilograms per hectare</p></div>
                          </div>
                        </div>
                    </div>
